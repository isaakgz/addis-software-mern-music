        ...
        {status === "loading" ? (
          ...
          <>
            ...
            <ChartContainer>
              ...
              <ChartWrapper>
                <ChartDescription>
                  ...
                  different genres. The bars represent how many songs exist in each
                  genre, providing a clear view of the genre's popularity.
                </ChartDescription>
                <Chart>
            ...
            <ChartContainer>
              ...
              <ChartWrapper>
                <ChartDescription>
                  This chart provides a comparison of how many songs and albums each
                  artist has produced. The two bars represent the number of songs
                  and albums respectively for each artist.
                </ChartDescription>
                <Chart>
                  <ResponsiveContainer width="100%" height={250}>
            ...
            <ChartContainer>
              ...
              <ChartWrapper>
                <ChartDescription>
                  This chart displays how many songs are in each album. It's useful
                  for understanding the volume of content per album and identifying
                  larger collections.
                </ChartDescription>
                <Chart>
                  <ResponsiveContainer width="100%" height={250}>
